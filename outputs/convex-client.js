...
function renderUnits() {
  ...
  $("unit-roster").innerHTML = unitCards + conclaveCard + '<section class="content-group form-wide personnel-group"><div class="section-heading"><p class="eyebrow">Specialists</p><h3>Espionage operatives</h3><p class="hint">Recruit here; assign defenders and launch missions from Intelligence.</p></div><div class="operative-roster">' + operativeCards + '</div></section>';
